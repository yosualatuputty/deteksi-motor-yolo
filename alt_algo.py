    ...
    for result in results:
        ...
        for box in result.boxes:
            ...
            if class_id == MOTORCYCLE_CLASS_ID:  # Motorcycle class ID
                ...
                # Check if the bounding box meets the size criteria
                if width >= 35 and height >= 90:
...
def main():
    ...
    model = YOLO("newest-n.pt")

    # Path to the image
    image_path = "C:\\Users\\YOSUA N LATUPUTTY\\deteksi-motor\\images\\motor0367_png.rf.b9ff954c3796515a9aa02a9f1701f96c.jpg"
